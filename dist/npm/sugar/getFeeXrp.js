...
function getFeeXrp(client, cushion) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const serverInfo = (yield client.request({ command: 'server_info' })).result
            .info;
        const baseFee = (_a = serverInfo.validated_ledger) === null || _a === void 0 ? void 0 : _a.base_fee_hwa;
        if (baseFee == null) {
            throw new errors_1.XrplError('getFeeXrp: Could not get base_fee_hwa from server_info');
        }
